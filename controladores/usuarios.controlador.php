	...
	static public function ctrIngresoUsuario(){
		...
		if(isset($_POST["ingUsuario"])){
			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingUsuario"])){
				...
				}elseif($respuesta && $respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] != $encriptar){
				...
				echo '<br><div class="alert alert-danger">El usuario no puede contener caracteres especiales</div>';
